...
import AdminNotificationErrors from "./pages/AdminNotificationErrors";
      ...
      <BrowserRouter>
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/admin/notification-errors" element={<AdminRoute><AdminNotificationErrors /></AdminRoute>} />

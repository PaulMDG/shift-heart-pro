    ...
    <MobileLayout>
      <div className="px-5 py-5 space-y-5">
        ...
        <div className="bg-card rounded-2xl p-5 shadow-card text-center">
          ...
          <h2 className="text-lg font-bold text-card-foreground">Sarah Johnson</h2>
          <p className="text-xs text-muted-foreground mt-0.5">Certified Home Health Aide</p>
          <div className="flex items-center justify-center gap-4 mt-4">
            <div className="text-center">
              <p className="text-lg font-bold text-card-foreground">142</p>
              <p className="text-[10px] text-muted-foreground">Shifts Done</p>
            </div>
            <div className="w-px h-8 bg-border" />
            <div className="text-center">
              <p className="text-lg font-bold text-card-foreground">4.9</p>
              <p className="text-[10px] text-muted-foreground">Rating</p>
            </div>
            <div className="w-px h-8 bg-border" />
            <div className="text-center">
              <p className="text-lg font-bold text-card-foreground">98%</p>
        ...
        {/* Logout */}
        <button className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl border border-destructive/20 text-destructive text-sm font-semibold hover:bg-destructive/5 transition-colors">
